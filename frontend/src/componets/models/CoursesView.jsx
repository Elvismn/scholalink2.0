...
import { useCourseAPI } from '../../services/api';
    ...
    <div className="p-4 lg:p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0 mb-6">
        <div className="text-center lg:text-left">
          <h2 className="text-xl lg:text-2xl font-bold text-gray-800">Courses Management</h2>
      ...
      {!loading && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          {displayCourses.map((course) => (
            <div key={course._id} className="bg-white rounded-lg shadow-sm border p-4 lg:p-6 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  <span>📝</span>
                  <span className="font-mono bg-gray-100 px-2 py-1 rounded text-xs truncate">{course.code}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <span>👨‍🏫</span>
                ...
                {course.department && (
                  <div className="flex items-center space-x-2">
                    <span>🏢</span>
                    <span className="truncate">Department: {course.department}</span>
                  </div>
                )}
                {course.description && (
                  <div className="flex items-start space-x-2">
                    <span>📄</span>
                    <span className="text-xs line-clamp-2">{course.description}</span>
                  </div>
                )}
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={handleInputChange} 
                    required 
                    className="w-full border border-gray-300 rounded-lg px-3 py-3 lg:py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-base"
