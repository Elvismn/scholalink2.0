      ...
      {!loading && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          {displayInventory.map((item) => (
            <div key={item._id} className="bg-white rounded-lg shadow-sm border p-4 lg:p-6 hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="px-2 py-1 rounded-full text-xs bg-gray-100 text-gray-800 truncate max-w-[120px]">
                    {item.category}
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <span>🔄</span>
                  <span className={`px-2 py-1 rounded-full text-xs ${getConditionColor(item.condition)} truncate max-w-[100px]`}>
                    {item.condition}
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                {item.lastChecked && (
                  <div className="flex items-center space-x-2">
                    <span>📅</span>
                    <span className="text-xs">Last Checked: {formatDate(item.lastChecked)}</span>
                  </div>
                )}
              </div>
